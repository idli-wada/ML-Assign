...
def main():
    ...
    for i in range(n_epochs):
        ...
        #appending data to lists for plots
    ...
    plt.plot(range(n_epochs),loss_train_list,'r',label='Training loss')
    plt.plot(range(n_epochs),loss_valid_list,'b',label='Validation loss')
    plt.plot(train_accuracy_list,'r',label='Training accuracy')
    plt.plot(valid_accuracy_list,'g',label='Validation accuracy')
    plt.xlabel('Epochs')
